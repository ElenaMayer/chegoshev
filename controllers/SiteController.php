...
class SiteController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'numerology'],
                'rules' => [
                    [
                        'actions' => ['logout', 'numerology'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionNumerology()
    {
        if($_GET && ($birthday = $_GET['birthday']) && ($name = $_GET['name'])){
